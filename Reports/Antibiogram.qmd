...
`r tools::toTitleCase(pair_text)`–drug combinations with fewer than 30 isolates tested are `r shown_text`<span id="fnref-1"><a href="#fn-1" class="footnote-arrow"><sup>1</sup></a></span>.
...
Each cell shows the number of isolates interpreted as susceptible over the total number of isolates tested for a given `r pair_text`–drug pair.
