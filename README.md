...
<img src="www/img/logoDark.png" alt="AMR Visualizer Logo" width="300"/>
...
| **Microorganism names**   | `E. coli` → _Escherichia coli_                |
...
- Raw values (MIC values) _or_ pre-interpreted S/I/R codes
